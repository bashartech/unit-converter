...
setOutputUnit(value)
 ...
 if(inputValue !== null && inputUnit && outputUnit){
  ...
  return (
    ...
    <div className=" box flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
    {/* Center the unit converter card within the screen */}
    <div className=" main max-w-md w-full p-6 bg-card rounded-lg shadow-lg">
